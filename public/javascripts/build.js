...
/***/ function(module, exports, __webpack_require__) {
	...
	var Catalogue = __webpack_require__(2);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var templateFunc = __webpack_require__(3);
	...
	var Catalogue = function () {
	  ...
	  _createClass(Catalogue, [{
	    ...
	    value: function renderTree() {
	      ...
	      this._getTreeFromServer('./', function (tree) {
	        _this._el.innerHTML = templateFunc({
	          files: tree.children
	        });
	      });
	    }
	  }, {
	    key: '_onFolderIcoClick',
	    value: function _onFolderIcoClick(event) {
	      if (event.target.dataset.selector !== 'folder-ico') {
	        return;
	      }
	
	      var folderElement = event.target.closest('[data-selector="folder"]');
	
	      var state = folderElement.dataset.state;
	    ...
	    key: '_onAddCommentClick',
	    value: function _onAddCommentClick(event) {
	      var button = event.target;
	      if (button.dataset.selector !== 'add-comment-button') {
	        return;
	      }
	
	      var fileElement = button.closest('[data-component="file"]');
	      this._showCommentFormOn(fileElement);
	    }
	  }, {
	    key: '_onSaveCommentClick',
	    value: function _onSaveCommentClick(event) {
	      var button = event.target;
	      ...
	      var fileElement = button.closest('[data-component="file"]');
	      var commentInput = fileElement.querySelector('[data-selector="comment-input"]');
	    ...
	    key: '_expandFolder',
	    value: function _expandFolder(folderElement) {
	      var folderPath = folderElement.dataset.path;
	
	      this._getTreeFromServer(folderPath, function (tree) {
	    ...
	    key: '_reduceFolder',
	    value: function _reduceFolder(folderElement) {
	      var innerFiles = folderElement.querySelectorAll('[data-component="file"]');
	    ...
	    key: '_showCommentFormOn',
	    value: function _showCommentFormOn(element) {
	      var input = element.querySelector('[data-selector="comment-input"]');
	      var button = element.querySelector('[data-selector="save-comment-button"]');
	
	      input.classList.remove('js-hidden');
	      button.classList.remove('js-hidden');
	    }
	  }, {
	    key: '_sendCommentToServer',
	    value: function _sendCommentToServer(comment, fileElement) {
	    ...
	    key: '_getTreeFromServer',
	    value: function _getTreeFromServer(path, callback) {
	      var req = new XMLHttpRequest();
	    ...
	    key: '_addCommentToContainer',
	    value: function _addCommentToContainer(element, comment) {
	      var container = element.querySelector('[data-selector="comment-container"]');
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "  <div data-component=\"file\" data-path=\""
	    + alias2(alias1((depth0 != null ? depth0.path : depth0), depth0))
	    + "\" class=\"file-container\" data-selector=\""
	    + alias2(alias1((depth0 != null ? depth0.type : depth0), depth0))
	    + "\"\r\n       data-state=\"closed\">\r\n    <button class=\"add-comment-button\" data-selector=\"add-comment-button\">Add comment</button>\r\n\r\n"
	    + ((stack1 = helpers["if"].call(alias3,(depth0 != null ? depth0.children : depth0),{"name":"if","hash":{},"fn":container.program(2, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + ((stack1 = helpers.unless.call(alias3,(depth0 != null ? depth0.children : depth0),{"name":"unless","hash":{},"fn":container.program(4, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "\r\n    <div class=\"info\">\r\n      <b>Name:</b> "
	    + alias2(alias1((depth0 != null ? depth0.name : depth0), depth0))
	    + "<br>\r\n      <b>Type:</b> "
	    + alias2(alias1((depth0 != null ? depth0.type : depth0), depth0))
	    + "<br>\r\n"
	    + ((stack1 = helpers["if"].call(alias3,(depth0 != null ? depth0.children : depth0),{"name":"if","hash":{},"fn":container.program(6, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "      <b>Path:</b> "
	    + alias2(alias1((depth0 != null ? depth0.path : depth0), depth0))
	    + "<br>\r\n    </div>\r\n"
	    + ((stack1 = helpers["if"].call(alias3,(depth0 != null ? depth0.comments : depth0),{"name":"if","hash":{},"fn":container.program(8, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "    <input data-selector=\"comment-input\" class=\"js-hidden comment-input\">\r\n    <button data-selector=\"save-comment-button\" class=\"js-hidden save-button\">Save</button>\r\n  </div>\r\n";
	},"2":function(container,depth0,helpers,partials,data) {
	    return "      <img src=\"images/folder-icon80x80.png\" data-selector=\"folder-ico\">\r\n";
	},"4":function(container,depth0,helpers,partials,data) {
	    return "      <img src=\"images/file-icon80x80.png\">\r\n";
	},"6":function(container,depth0,helpers,partials,data) {
	    return "        <b>Content:</b> "
	    + container.escapeExpression(container.lambda((depth0 != null ? depth0.children : depth0), depth0))
	    + " files<br>\r\n";
	},"8":function(container,depth0,helpers,partials,data) {
	    var stack1;
	
	  return "      <br>\r\n      <div class=\"comments\">\r\n        <b>Comments:</b> <br>\r\n        <div class=\"comment-container\" data-selector=\"comment-container\">\r\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.comments : depth0),{"name":"each","hash":{},"fn":container.program(9, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "        </div>\r\n      </div>\r\n";
	},"9":function(container,depth0,helpers,partials,data) {
	    return "            - "
	    + container.escapeExpression(container.lambda((depth0 != null ? depth0.comment : depth0), depth0))
	    + " <br>\r\n";
